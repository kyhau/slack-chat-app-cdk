...
class SlackAppOAuthConstructsStack(Stack):
    def __init__(self, scope: Construct, id: str, oauth_table: ddb_.Table, settings, **kwargs) -> None:
        ...
        func_oauth.add_environment("OAuthDynamoDBTable", oauth_table.table_name)
